      ...
      <div className="min-h-screen p-8 bg-[var(--hover-brown-color)]">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <p className="text-lg text-[var(--background)] mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-lg text-[var(--background)] mb-4">
              <li>
          ...
          <section className="mb-8 text-[var(--background)]">
